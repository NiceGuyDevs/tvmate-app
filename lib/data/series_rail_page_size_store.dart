...
/// Persisted **Series** rail page size (visible posters per row).
///
/// Valid values: **4–12**, step **1**. Fresh install (no pref): **8** on all
/// platforms.
class SeriesRailPageSizeStore extends ChangeNotifier {
  SeriesRailPageSizeStore._();
  static final SeriesRailPageSizeStore instance = SeriesRailPageSizeStore._();

  static const _kPrefsKey = 'tvmatepro_series_rail_page_size_v1';
...
final SeriesRailPageSizeStore seriesRailPageSizeStore =
    SeriesRailPageSizeStore.instance;

...
/// TV-friendly registration screen — compact layout with D-pad keyboard support.
class RegisterScreen extends StatefulWidget {
  final VoidCallback onSuccess;
  final VoidCallback onLogin;
  const RegisterScreen({super.key, required this.onSuccess, required this.onLogin});
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final _loginLinkFocus = FocusNode();
  bool _loading = false;
  ...
  Future<void> _submit({String? removeDeviceId}) async {
    ...
    try {
      final res = await accountApi.register(
  ...
  Future<void> _googleSignUp() async {
    ...
    try {
      ...
      if (idToken == null) {
        if (mounted) setState(() { _error = 'Google sign-up failed: no ID token'; _googleLoading = false; });
        return;
      }
  ...
  Future<void> _completeGoogleSignUp(String idToken, {String? removeDeviceId}) async {
    try {
      ...
      if (e.code == 'MAX_DEVICES' && e.data != null && mounted) {
        ...
        if (chosen != null && mounted) {
          await _completeGoogleSignUp(idToken, removeDeviceId: chosen);
        }
        return;
      }
      setState(() { _error = e.message; });
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _loading
                            ...
                            : const Text('Create Account', style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white, fontSize: 14)),
                      ),
                    ),
                  ),
                  ...
                  FocusTraversalOrder(
                    ...
                    child: SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        label: const Text('Sign up with Google', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w500)),
                  ...
                  FocusTraversalOrder(
                    ...
                    child: TextButton(
                      focusNode: _loginLinkFocus,
                      onPressed: widget.onLogin,
                      child: const Text('Already have an account? Sign in', style: TextStyle(color: Color(0xFF818CF8), fontSize: 12)),
                    ),
                  ),
                ],
              ),
